...
export const privacyPolicy = {
	EN: {
		...
		blocks: [
			{ type: 'p', text: "At Troika Insurance, we are committed to protecting the privacy and security of our clients' personal information. This Privacy Policy explains how we collect, use, disclose, retain, and protect your personal information in accordance with applicable Canadian privacy laws, including the Personal Information Protection and Electronic Documents Act (PIPEDA) and applicable provincial legislation." },
			{ type: 'p', text: 'By using the Troika Insurance website or by choosing to provide your personal information through one of our insurance brokers, you consent to the practices described in this Privacy Policy.' },
			...
			{ type: 'p', text: 'Our website may contain links to third-party websites. This Privacy Policy does not apply to those sites, and we are not responsible for their privacy practices. We encourage you to review the privacy policies of any third-party websites you visit.' },

			{ type: 'h2', text: 'Collecting Personal Information' },
			{ type: 'p', text: 'We collect only the personal information necessary to provide our insurance brokerage services. Your personal information may be used for the following purposes:' },
			{ type: 'list', items: [
				'Providing, administering, and managing your insurance contracts',
				'Communicating with you about your insurance policies and our services',
				'Carrying out underwriting and claims processing activities',
				'Complying with our legal and regulatory obligations',
				'Preventing, detecting, and investigating fraud',
			] },
			{ type: 'p', text: 'The personal information we may collect includes, among other things:' },
			{ type: 'list', items: [
				'Personal identification information (name, address, date of birth, contact details, etc.)',
				'Financial information (payment information or financial history relevant to your insurance coverage)',
				'Insurance-related information (policy details, claims history, risk information, etc.)',
				'Usage data (information about your use of our website)',
			] },
			{ type: 'p', text: 'We obtain your consent before collecting, using, or disclosing your personal information, except where the law permits or requires otherwise. This consent may be express (for example, in writing) or implied (for example, when you voluntarily provide us with your information).' },
			...
			{ type: 'p', text: 'We may, however, disclose your personal information to third parties when necessary to provide our services, including:' },
			{ type: 'list', items: [
				'To insurers, for underwriting or claims processing purposes',
				'To our business partners and service providers who support our operations',
				'To government agencies or regulatory authorities where required by law',
			] },
			{ type: 'p', text: 'We retain personal information only for as long as necessary to fulfill the purposes for which it was collected and to meet our legal and regulatory obligations. Once no longer required, it is securely destroyed or anonymized in accordance with applicable requirements.' },

			{ type: 'h2', text: 'Security and Protection of Personal Information' },
			{ type: 'p', text: 'We have implemented appropriate technical, administrative, and organizational security measures to protect your personal information against loss, theft, unauthorized access, disclosure, alteration, or misuse. These measures include data encryption, access controls, secure storage systems, and internal personal information protection policies.' },
			{ type: 'p', text: 'You have the right to request access to the personal information we hold about you and to request correction if it is inaccurate, incomplete, or ambiguous. To exercise these rights, please contact our Personal Information Protection Officer.' },
			{ type: 'p', text: 'You may also withdraw your consent to the use of your personal information, subject to legal or contractual limitations.' },
			{ type: 'p', text: 'Your personal information may be stored or processed outside your province or country of residence where our service providers operate in other jurisdictions. By using our services, you consent to your information being transferred to those jurisdictions, which may be subject to different personal information protection laws.' },

			{ type: 'h2', text: 'Contact Us' },
			{ type: 'p', text: 'For any questions, concerns, or requests regarding this Privacy Policy or our personal information protection practices, please contact us:' },
			{ type: 'list', items: [
